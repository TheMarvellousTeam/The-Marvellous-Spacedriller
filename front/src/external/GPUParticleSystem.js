...
module.exports = THREE.GPUParticleSystem = function(options) {
  ...
  self.particleNoiseTex = THREE.ImageUtils.loadTexture( require('file?[hash].[ext]!../asset/texture/perlin-512.png') );
  self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

  self.particleSpriteTex = THREE.ImageUtils.loadTexture( require('file?[hash].[ext]!../asset/texture/particle2.png') );
